...
RSpec.describe 'As a Merchant Admin' do
  before(:each) do
    ...
    @order_1 = @user.orders.create!(name: 'Meg', address_id: @home_address.id, status: 'Pending')
    @order_2 = @user.orders.create!(name: 'Meg', address_id: @home_address.id, status: 'Pending')
