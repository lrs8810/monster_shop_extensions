...
RSpec.describe 'merchant show page', type: :feature do
  describe 'As a user' do
    before :each do
      ...
      hershey_address = @user.addresses.create(address: '123 Stang Ave', city: 'Hershey', state: 'PA', zip: 17_033, nickname: 0)
      denver__address_1 = @user.addresses.create(address: '123 Zanti St', city: 'Denver', state: 'CO', zip: 80_204, nickname: 1)
      denver__address_2 = @user.addresses.create(address: '123 Dao St', city: 'Denver', state: 'CO', zip: 80_210, nickname: 2)
      @order_1 = @user.orders.create!(name: 'Meg', address_id: hershey_address.id)
      @order_2 = @user.orders.create!(name: 'Brian', address_id: denver__address_1.id)
      @order_3 = @user.orders.create!(name: 'Mike', address_id: denver__address_2.id)
